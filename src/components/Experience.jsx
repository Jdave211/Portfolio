  ...
  return (
    <VerticalTimelineElement
      ...
      icon={
        ...
        <div className='flex justify-center items-center w-full h-full ml-3'>
      ...
      <div className='w-full flex'>
        <motion.p 
          ...
          className='mt-3 max-w-3xl leading-[30px] text-secondary text-[17px]'>
            Dave's Nest. Where I attempt to take on numerous social issues and provide my opinion, sometimes even a through unconventional approaches .
        </motion.p>
      </div>
